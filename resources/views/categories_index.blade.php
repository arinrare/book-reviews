...
<div class="pl-20 pr-20 mx-auto mt-10 w-full max-w-4xl flex flex-col gap-10">
    <!-- Authors -->
    <div class="flex flex-wrap bg-neutral-800/80 rounded-lg shadow-lg p-6">
        <h2 class="w-full text-xl sm:text-2xl font-bold mb-2 text-center text-white border-b border-neutral-700 pb-1">Authors</h2>
    ...
    <!-- Genres -->
    <div class="flex flex-wrap bg-neutral-800/80 rounded-lg shadow-lg p-6">
        <h2 class="w-full text-xl sm:text-2xl font-bold mb-2 text-center text-white border-b border-neutral-700 pb-1">Genres</h2>
        <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-2">
    ...
    <!-- Publishers -->
    <div class="flex flex-wrap bg-neutral-800/80 rounded-lg shadow-lg p-6">
        <h2 class="w-full text-xl sm:text-2xl font-bold mb-2 text-center text-white border-b border-neutral-700 pb-1">Publishers</h2>
        <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-2">
    ...
    <!-- Series -->
    <div class="flex flex-wrap bg-neutral-800/80 rounded-lg shadow-lg p-6">
        <h2 class="w-full text-xl sm:text-2xl font-bold mb-2 text-center text-white border-b border-neutral-700 pb-1">Series</h2>
        <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-2">
            @forelse($series as $s)
